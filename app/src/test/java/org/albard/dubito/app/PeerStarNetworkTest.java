...
public final class PeerStarNetworkTest {
    ...
    void testConnection() throws IOException, InterruptedException {
        ...
        try (final PeerNetwork app1 = PeerStarNetwork.createBound(app1Id, "127.0.0.1", 9000, app1Dispatcher,
                messengerFactory);
                final PeerNetwork app2 = PeerStarNetwork.createBound(app2Id, "127.0.0.1", 9001, app2Dispatcher,
                        messengerFactory);
                final PeerNetwork app3 = PeerStarNetwork.createBound(app3Id, "127.0.0.1", 9002, app3Dispatcher,
                        messengerFactory)) {
